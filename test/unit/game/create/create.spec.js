...
describe("game/create", () => {
    ...
    it("should reset with init method", () => {
        ...
        expect(mockedBes.subscribe).toHaveBeenCalledWith(
            sut.playerInfos,
            "name",
            expect.any(Function),
        );
    ...
    it("should navigate to {version}/create/{id} after game initialization", () => {
        ...
        expect(mockedRouter.navigateToRoute).toHaveBeenCalledWith("create", {
    ...
    it("should navigate to play/{id} after the game creation", () => {
        ...
        expect(mockedRouter.navigateToRoute).toHaveBeenCalledWith("play", {
            id: "the_game_id",
            version: "latest",
        });
