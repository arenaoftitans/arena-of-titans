...
public class Main {
    public static void main(String[] Args) {
        ...
        Square currentSquare = plateau.getSquare(1, 8);
            ...
            while (isOver==false){
                ...
                while(isEmpty){
                    ...
                    if(carte=='K'){
                        ...
                        if(couleur=='J'){chosenCard = new KingCard(plateau,Color.YELLOW);}
                    }
                    if(carte=='Q'){
                        ...
                        if(couleur=='J'){chosenCard = new QueenCard(plateau,Color.YELLOW);}
                    }
                    if(carte=='A'){
                        ...
                        if(couleur=='J'){chosenCard = new AssassinCard(plateau,Color.YELLOW);}
                    }
                    if(carte=='B'){
                        ...
                        if(couleur=='J'){chosenCard = new BishopCard(plateau,Color.YELLOW);}
                    }
                    if(carte=='W'){
                        ...
                        if(couleur=='J'){chosenCard = new WarriorCard(plateau,Color.YELLOW);}
                    }
                    if(carte=='M'){
                        ...
                        if(couleur=='J'){chosenCard = new WizardCard(plateau,Color.YELLOW);}
                    }
                    if(carte=='R'){
                        ...
                        if(couleur=='J'){chosenCard = new RiderCard(plateau,Color.YELLOW);}
                    }
