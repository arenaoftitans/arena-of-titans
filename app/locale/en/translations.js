export default {
    ...
    site: {
        founders: {
            story: {
                p1:
                    "A white paper mask, a suit and a black hat. We do not know much more about this strange character who would have been designated by the Titans to gather an extraordinary team of architects and build the Arena. Many rumors run on Mr.A.D., some claim to have seen him in the World of Humans and others in the Mirror. It is thought that it is a Shadow having the power to cross the Worlds but it could also belong to no known peoples ...",
                p2:
