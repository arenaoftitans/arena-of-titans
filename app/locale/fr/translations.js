export default {
    ...
    game: {
        ...
        visit: {
            cards:
                "Pour cela, tu peux utiliser les cartes de déplacement. Lorsque tu cliques sur une carte, les cases possibles sont mise en évidence sur le plateau.",
            goal:
                "Le but du jeu est d'atteindre le plus vite possible la dernière ligne et d'y rester un tour complet.",
            ...
            title: "Tutoriel",
            trumps:
                "Tu peux également utiliser des atouts pour te renforcer ou mettre des pénalités à d'autres joueurs.",
        },
    },
    global: {
        alias: "Pseudo",
    ...
    powers: {
        ...
        inveterate_ride_description:
            "Les cavaliers peuvent se déplacer sur les cases de n'importe quelle couleur",
    ...
    site: {
        ...
        heroes: {
            ...
            arline_short_description:
                "Arline s’est bâtie une solide réputation d’archère d’élite même parmi les hautes castes de la société arlineique. Ceux qui l’ont sous-estimée ne sont plus en mesure de le regretter.",
            djor: "Djör",
            djor_description:
            ...
            kharliass_short_description:
                "Kharliass est un démon de classe qui plonge ses proies dans un état de confusion totale en revêtant leur propre apparence juste avant de les tuer.",
            luni: "Luni",
            luni_description:
    ...
    trumps: {
        ...
        fortress_black_description:
            "Empêche le joueur de se déplacer sur les cases noires pendant deux tours.",
        fortress_blue: "Forteresse Bleue",
        fortress_blue_description:
            "Empêche le joueur de se déplacer sur les cases bleues pendant deux tours.",
        fortress_red: "Forteresse Rouge",
        fortress_red_description:
            "Empêche le joueur de se déplacer sur les cases rouges pendant deux tours.",
        fortress_yellow: "Forteresse Jaune",
        fortress_yellow_description:
            "Empêche le joueur de se déplacer sur les cases jaunes pendant deux tours.",
