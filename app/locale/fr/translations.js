export default {
    ...
    "powers": {
        ...
        "impassable_description": "Vos atouts « Forteresses » ne peuvent être annulés par l’effet de l’atout « Bélier »",
        "inveterate_ride": "Chevauchée Intrépide",
        "inveterate_ride_description": "Vos cartes \"Cavaliers\" peuvent avancer sur des cases de n'importe quelle couleur.",
    ...
    "site": {
        ...
        "moves": {
            "assassin_black": "Assassin de la Montagne",
            "assassin_black_moves": "Déplacement de deux cases \"Montagne\" en ligne ou en diagonal. Coup spécial : Assassinat pour faire reculer un joueur sur une case \"Montagne\".",
            "assassin_blue": "Assassin de l'Eau",
            "assassin_blue_moves": "Déplacement de deux cases \"Eau\" en ligne ou en diagonal. Coup spécial : Assassinat pour faire reculer un joueur sur une case \"Eau\".",
            "assassin_red": "Assassin de la Forêt",
            "assassin_red_moves": "Déplacement de deux cases \"Forêt\" en ligne ou en diagonal. Coup spécial : Assassinat pour faire reculer un joueur sur une case \"Forêt\".",
            "assassin_yellow": "Assassin du Désert",
            "assassin_yellow_moves": "Déplacement de deux cases \"Désert\" en ligne ou en diagonal. Coup spécial : Assassinat pour faire reculer un joueur sur une case \"Désert\".",
            "bishop_black": "Fou de la Montagne",
            "bishop_black_moves": "Déplacement de deux cases \"Montagne\" ou \"Eau\" en diagonale. Les cases peuvent être de deux couleurs différentes",
            "bishop_blue": "Fou de l'Eau",
            "bishop_blue_moves": "Déplacement de deux cases \"Eau\" ou \"Désert\" en diagonale. Les cases peuvent être de deux couleurs différentes",
            "bishop_red": "Fou de la Forêt",
            "bishop_red_moves": "Déplacement de deux cases \"Forêt\" ou \"Montagne\" en diagonale. Les cases peuvent être de deux couleurs différentes",
            "bishop_yellow": "Fou du Désert",
            "bishop_yellow_moves": "Déplacement de deux cases \"Désert\" ou \"Forêt\" en diagonale. Les cases peuvent être de deux couleurs différentes",
            "desert": "Désert",
            "forest": "Forêt",
            "king_black": "Roi de la Montagne",
            ...
            "mountain": "Montagne",
            "pitch": {
                "p1": "L'île des Titans se compose de 4 types de terrains : Forêt, Eau, Montagne et Désert.",
                "p2": "Les cartes Déplacements te permettent d'invoquer un Esprit qui te guidera à travers ces territoires.",
            ...
            "water": "Eau",
            "wizard_black": "Magicien de la Montagne",
            "wizard_black_moves": "Déplacement d'une case en ligne ou en diagonal. La case peut être de n'importe quelle couleur",
            "wizard_blue": "Magicien de l'Eau",
            "wizard_blue_moves": "Déplacement d'une case en ligne ou en diagonal. La case peut être de n'importe quelle couleur",
            "wizard_red": "Magicien de la Forêt",
            "wizard_red_moves": "Déplacement d'une case en ligne ou en diagonal. La case peut être de n'importe quelle couleur",
            "wizard_yellow": "Magicien du Désert",
            "wizard_yellow_moves": "Déplacement d'une case en ligne ou en diagonal. La case peut être de n'importe quelle couleur"
        },
        "page_title": {
    ...
    "trumps": {
        ...
        "fortress_yellow_description": "Empêche le joueur de se déplacer sur les cases du Désert pendant deux tours.",
