...
@inject(History, I18N, EventAggregator)
export class Game {
    ...
    constructor(history, i18n, ea) {
        this._i18n = i18n;
        this._ea = ea;

        this._popupMessageId;
        this._popupMessage = {};
        this._ea.subscribe('i18n:locale:changed', () => this._translatePopupMessage());
    ...
    activate() {
        this._ea.subscribe('aot:api:error', data => {
